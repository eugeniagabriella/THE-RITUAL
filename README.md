...
With limited light, environmental storytelling, and tense exploration, every decision brings players closer to either escape or danger.
...
This project was developed as a **solo project**, where I was responsible for the complete development process from concept to release.
...
- Built immersive game environments
- Integrated 3D assets, materials, audio, and UI
- Tested, debugged, and optimized gameplay
- Published the final game on itch.io and incorporated player feedback into later improvements
...
> Note: Some generated Unity folders (such as `Library`, `Temp`, and `Logs`) are excluded from version control using `.gitignore`.
